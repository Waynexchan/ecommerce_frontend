                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-lg-8">
                                                        ...
                                                        <p className="fw-bold text-muted mb-0">
                                                            ...
                                                            {r.rating == 2 && <div><i className="fas fa-star" /><i className="fas fa-star" /></div>}
                                                            {r.rating == 3 && <div><i className="fas fa-star" /><i className="fas fa-star" /><i className="fas fa-star" /></div>}
                                                            {r.rating == 4 && <div><i className="fas fa-star" /><i className="fas fa-star" /><i className="fas fa-star" /><i className="fas fa-star" /></div>}
                                                            {r.rating == 5 && <div><i className="fas fa-star" /><i className="fas fa-star" /><i className="fas fa-star" /><i className="fas fa-star" /><i className="fas fa-star" /></div>}
