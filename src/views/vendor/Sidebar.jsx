    ...
    return (
        ...
        <div className="col-md-3 col-lg-2 sidebar-offcanvas bg-dark navbar-dark" id="sidebar" role="navigation" >
            <ul className="nav nav-pills flex-column mb-auto nav flex-column pl-1 pt-2">
                ...
                <li className="mb-3">
                    <Link to="/vendor/earning/" className={isActiveLink(location.pathname, '/vendor/None/') ? "nav-link text-white active" : "nav-link text-white"}>
                ...
                <li className="mb-3">
                    <Link to="/vendor/product/new/" className={isActiveLink(location.pathname, '/vendor/None/') ? "nav-link text-white active" : "nav-link text-white"}>
                ...
                <li className="mb-3">
                    <Link to="/vendor/settings/" className={isActiveLink(location.pathname, '/vendor/None/') ? "nav-link text-white active" : "nav-link text-white"}>
                        <i className="bi bi-gear-fill" /> Settings{" "}
                    </Link>
                </li>

                <li className="mb-3">
                    <Link to="/logout" className={isActiveLink(location.pathname, '/vendor/None/') ? "nav-link text-white active" : "nav-link text-white"}>
